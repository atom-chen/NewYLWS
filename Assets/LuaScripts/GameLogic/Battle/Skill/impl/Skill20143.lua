...
local Skill20143 = BaseClass("Skill20143", SkillBase)

function Skill20143:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_NORMALFLY, 70, giver, self, pos, forward, normalFlyParam)
end
