...
local Skill10419 = BaseClass("Skill10419", AtkFunc1)
...
function Skill10419:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                local giver = statusGiverNew(performer:GetActorID(), 10419)
