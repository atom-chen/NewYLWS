...
local Skill20282 = BaseClass("Skill20282", SkillBase)

function Skill20282:Perform(performer, target, performPos, special_param)
    ...
    local giver = statusGiverNew(performer:GetActorID(), 20282)
