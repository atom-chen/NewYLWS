...
local Skill10392 = BaseClass("Skill10392", SkillBase)

function Skill10392:Perform(performer, target, performPos, special_param)
    ...
    local giver = StatusGiver.New(performer:GetActorID(), 10392)
    local mediaParam = {
...
function Skill10392:SelectSkillTarget(performer, target)
