...
local Skill20121 = BaseClass("Skill20121", SkillBase)

function Skill20121:Perform(performer, target, performPos, special_param)
        ...
        ActorManagerInst:Walk(
            function(tmpTarget)
                ...
                if injure > 0 then
                    ...
                    local giver = StatusGiver.New(performer:GetActorID(), 20121) 
