...
local Skill12144 = BaseClass("Skill12144", SkillBase)
local NormalFly = require("GameLogic.Battle.Medium.impl.NormalFly")

function Skill12144:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_NORMALFLY, 43, giver, self, pos, forward, normalFlyParam)
end
