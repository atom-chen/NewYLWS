...
local Skill10345 = BaseClass("Skill10345", SkillBase)

function Skill10345:Perform(performer, target, performPos, special_param)
    ...
    local giver = StatusGiver.New(performer:GetActorID(), 10345)
