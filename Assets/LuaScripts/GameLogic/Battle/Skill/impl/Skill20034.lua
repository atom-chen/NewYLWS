...
local Skill20034 = BaseClass("Skill20034", SkillBase)

function Skill20034:Perform(performer, target, performPos, special_param)
    ...
    local giver = StatusGiver.New(performer:GetActorID(), 20034)
