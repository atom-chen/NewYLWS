...
local Skill12012 = BaseClass("Skill12012", SkillBase)

function Skill12012:Perform(performer, target, performPos, special_param)
    ...
    local function AddWeakStatus(target)
        ...
        local giver = StatusGiverNew(performer:GetActorID(), 12012)
        local statusNTimeBeHurtChg = factory:NewStatusNTimeBeHurtMul(giver, time, FixAdd(1, FixDiv(self:D(), 100)), {21015})
