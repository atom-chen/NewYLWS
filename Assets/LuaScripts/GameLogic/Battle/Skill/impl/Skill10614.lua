...
local Skill10614 = BaseClass("Skill10614", SkillBase)

function Skill10614:Perform(performer, target, performPos, special_param)
...
function Skill10614:CreateMedium(performer, target, special_param, hurtMul)
