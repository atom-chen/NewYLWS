...
local Skill12031 = BaseClass("Skill12031", SkillBase)

function Skill12031:Perform(performer, target, performPos, special_param)
    ...
    if injure > 0 then
        local giver = StatusGiver.New(performer:GetActorID(), 12031)
    ...
    if special_param.keyFrameTimes == 3 and self.m_level == 3 then
