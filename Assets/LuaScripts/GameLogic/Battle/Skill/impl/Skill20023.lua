...
local Skill20023 = BaseClass("Skill20023", AtkFunc1)
local Formular = Formular

function Skill20023:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                local giver = statusGiverNew(performer:GetActorID(), 20023)
