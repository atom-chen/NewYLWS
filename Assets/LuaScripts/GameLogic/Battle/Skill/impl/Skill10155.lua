...
local Skill10155 = BaseClass("Skill10155", SkillBase)
...
function Skill10155:Perform(performer, target, performPos, special_param)
    ...
    performer:ActiveFenshenSkill(10155, target:GetActorID())
end
