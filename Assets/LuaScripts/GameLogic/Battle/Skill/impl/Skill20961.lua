...
local Skill20961 = BaseClass("Skill20961", SkillBase)

function Skill20961:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)
            ...
            local giver = statusGiverNew(performer:GetActorID(), 20961)
            ...
            if self.m_level >= 2 then
                ...
                attrBuff:AddAttrPair(ACTOR_ATTR.FIGHT_MOVESPEED, FixMul(chgMoveSpeed, -1))
