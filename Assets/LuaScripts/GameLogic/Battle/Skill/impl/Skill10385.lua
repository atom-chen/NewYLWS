...
local Skill10385 = BaseClass("Skill10385", SkillBase)

function Skill10385:Perform(performer, target, performPos, special_param)
    ...
    local giver = StatusGiver.New(performer:GetActorID(), 10385)
