...
local Skill20951 = BaseClass("Skill20951", SkillBase)


function Skill20951:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)
            ...
            if injure > 0 then
                local giver = StatusGiverNew(performer:GetActorID(), 20951)
