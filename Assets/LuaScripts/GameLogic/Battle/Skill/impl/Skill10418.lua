...
local Skill10418 = BaseClass("Skill10418", AtkFunc1)
...
function Skill10418:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                local giver = statusGiverNew(performer:GetActorID(), 10418)
