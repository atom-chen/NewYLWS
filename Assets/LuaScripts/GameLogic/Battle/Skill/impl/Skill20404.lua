...
local Skill20404 = BaseClass("Skill20404", AtkFunc1)

function Skill20404:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                local giver = statusGiverNew(performer:GetActorID(), 20404)
