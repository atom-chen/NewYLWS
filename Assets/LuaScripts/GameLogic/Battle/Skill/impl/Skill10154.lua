...
local Skill10154 = BaseClass("Skill10154", SkillBase)
...
function Skill10154:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_NORMALFLY, 61, giver, self, pos, forward, normalFlyParam)

    performer:ActiveFenshenSkill(10154, target:GetActorID())
end
