...
local Skill10025 = BaseClass("Skill10025", AtkFunc1)
...
function Skill10025:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                ...
                local giver = statusGiverNew(performer:GetActorID(), 10025)
