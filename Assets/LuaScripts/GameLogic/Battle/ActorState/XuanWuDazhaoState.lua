...
local XuanWuDazhaoState = BaseClass("XuanWuDazhaoState", DazhaoState)
local SAnimationState = require "GameLogic.Battle.Animator.SAnimator"

XuanWuDazhaoState.PHASE_PREPARE = 0
XuanWuDazhaoState.PHASE_SKILL = 1

function XuanWuDazhaoState:InitAnim()
...
function XuanWuDazhaoState:DoAtk()
    self:OnPrepareEnd()
    ...
    self.m_currPhase = XuanWuDazhaoState.PHASE_SKILL
    self.m_keyFrames = 1
...
function XuanWuDazhaoState:End()
    self:EndPrepareAudio()
    self:ClearPreparePhase()
    DazhaoState.End(self)
end

function XuanWuDazhaoState:GetSkillCfg()
    return self.m_skillCfg
end

return XuanWuDazhaoState