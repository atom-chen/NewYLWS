...
local config = {
    ...
    path = 'Timeline/Copy/plot2/plot2-3wave3end.prefab',
    assetPath = 'Timeline/Copy/plot2/plot2-3wave3end.playable',
	...
	load_list = {
		...
		{
            path = "Models/1004/1004_2.prefab",
            createInstance = true,
            name = "1004",
            instancePos = {0, 0, 0},
            instanceRotation = {0, 0, 0},
		...
		{
		    path = "Models/1044/1044_2.prefab",
            createInstance = true,
            name = "1044",
            instancePos = {0, 0, 0},
            instanceRotation = {0, 0, 0},
