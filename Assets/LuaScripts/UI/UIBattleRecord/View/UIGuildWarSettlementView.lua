...
local UIGuildWarSettlementView = BaseClass("UIGuildWarSettlementView", base)

local string_format = string.format

function UIGuildWarSettlementView:OnCreate()
    base.OnCreate(self)
...
function UIGuildWarSettlementView:OnEnable(...)
    base.OnEnable(self, ...)
    ...
    -- print("add_jungong  " ,msgObj.add_jungong)
...
return UIGuildWarSettlementView