...
--
local function isempty(hashtable)
...
--对链表操作
local function findIndex(tb, filter)
	if tb then
...
--整数list 
local function copyNumList(fromList)
	local table_insert = table.insert

	if fromList then
		if next(fromList) then
