...
local Skill10024 = BaseClass("Skill10024", AtkFunc1)
...
function Skill10024:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                ...
                local giver = statusGiverNew(performer:GetActorID(), 10024)
