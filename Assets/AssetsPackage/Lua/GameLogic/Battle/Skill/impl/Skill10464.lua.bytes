...
local Skill10464 = BaseClass("Skill10464", SkillBase)
local NormalFly = require("GameLogic.Battle.Medium.impl.NormalFly")

function Skill10464:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_NORMALFLY, 34, giver, self, pos, forward, normalFlyParam)
end
