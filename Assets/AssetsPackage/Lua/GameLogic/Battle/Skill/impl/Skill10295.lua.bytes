...
local Skill10295 = BaseClass("Skill10295", SkillBase)
local NormalFly = require("GameLogic.Battle.Medium.impl.NormalFly")

function Skill10295:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_NORMALFLY, 29, giver, self, pos, forward, normalFlyParam)
end
