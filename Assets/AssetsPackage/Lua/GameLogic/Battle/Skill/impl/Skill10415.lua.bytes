...
local Skill10415 = BaseClass("Skill10415", AtkFunc1)
...
function Skill10415:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                local giver = statusGiverNew(performer:GetActorID(), 10415)
