...
local Skill20112 = BaseClass("Skill20112", SkillBase)

function Skill20112:Perform(performer, target, performPos, special_param)
    ...
    MediumManagerInst:CreateMedium(MediumEnum.MEDIUMTYPE_20112, 64, giver, self, pos, forward, mediaParam)
end
