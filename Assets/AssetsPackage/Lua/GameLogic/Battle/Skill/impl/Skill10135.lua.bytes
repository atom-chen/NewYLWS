...
local Skill10135 = BaseClass("Skill10135", AtkFunc1)
...
function Skill10135:Perform(performer, target, performPos, special_param)
    ...
    ActorManagerInst:Walk(
        function(tmpTarget)       
            ...
            if injure > 0 then
                ...
                local giver = statusGiverNew(performer:GetActorID(), 10135)
