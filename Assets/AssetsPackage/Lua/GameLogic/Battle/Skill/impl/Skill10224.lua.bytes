...
local Skill10224 = BaseClass("Skill10224", SkillBase)

function Skill10224:Perform(performer, target, performPos, special_param)
    ...
    pos:Add(performer:GetRight() * -0.201)
    pos:Add(forward * 2.14)
