    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_7140 = _Time;
                float2 node_1909 = (((o.uv0+node_7140.g*float2(0.05,0.05))+(o.uv0+node_7140.g*float2(0.05,0.05)))*_Noies);
...
////// Lighting:
                float4 node_7140 = _Time;
                float2 node_1909 = (((i.uv0+node_7140.g*float2(0.05,0.05))+(i.uv0+node_7140.g*float2(0.05,0.05)))*_Noies);
                float4 _Main_Tex_var = tex2D(_Main_Tex,TRANSFORM_TEX(node_1909, _Main_Tex));
                float2 node_1280 = ((i.uv0+node_7140.g*float2(-0.01,-0.01))+_Main_Tex_var.r);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_8096 = _Time;
                float2 node_1909 = (((o.uv0+node_8096.g*float2(0.05,0.05))+(o.uv0+node_8096.g*float2(0.05,0.05)))*_Noies);
                float4 _Main_Tex_var = tex2Dlod(_Main_Tex,float4(TRANSFORM_TEX(node_1909, _Main_Tex),0.0,0));
                v.vertex.xyz += (_Vertex*v.normal*_Main_Tex_var.g);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                o.pos = UnityObjectToClipPos( v.vertex );
