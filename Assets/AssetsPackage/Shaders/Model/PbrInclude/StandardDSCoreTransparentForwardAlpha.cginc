...
#ifndef UNITY_STANDARD_CORE_TRANSPRENT_FORWARD_ALPHA_INCLUDED
#define UNITY_STANDARD_CORE_TRANSPRENT_FORWARD_ALPHA_INCLUDED
...
#include "UnityStandardConfig.cginc"
	...
	half4 fragTransparentDS(VertexOutputDS i, in float face : VFACE)
	{
		UNITY_APPLY_DITHER_CROSSFADE(i.pos.xy);

		fixed4 node = tex2D(_AlphaTex,TRANSFORM_TEX(i.tex, _AlphaTex));
		...
		half4 c = BRDF3_Unity_PBS(s.diffColor, s.specColor, s.oneMinusReflectivity, s.smoothness, s.normalWorld, worldViewDir, gi.light, gi.indirect);
	...
	half4 fragBaseDS(VertexOutputDS i, in float face : VFACE) : SV_Target{ return fragTransparentDS(i, face); }
...
#endif // UNITY_STANDARD_CORE_TRANSPRENT_FORWARD_ALPHA_INCLUDED