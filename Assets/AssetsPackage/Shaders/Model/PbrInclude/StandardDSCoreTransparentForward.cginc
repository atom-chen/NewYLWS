...
#ifndef UNITY_STANDARD_CORE_TRANSPRENT_FORWARD_INCLUDED
#define UNITY_STANDARD_CORE_TRANSPRENT_FORWARD_INCLUDED
...
#include "UnityStandardConfig.cginc"
	...
	half4 fragTransparentDS(VertexOutputDS i, in float face : VFACE)
	{
		...
		fixed4 node = tex2D(_MainTex,TRANSFORM_TEX(i.tex, _MainTex));
