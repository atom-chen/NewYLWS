...
Shader "Custom/sceneobj-gpuinst" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
				...
				half2 capCoord;
				capCoord.x = dot(UNITY_MATRIX_IT_MV[0].xyz, _NormalDir*v.normal);
				capCoord.y = dot(UNITY_MATRIX_IT_MV[1].xyz, _NormalDir*v.normal);
...
////// Lighting:
				...
				finalColor = finalColor * (mc * 1.0);
/// Final Color:
				// finalColor = finalColor * (1 - _EffectColor.a) + _EffectColor.rgb * _EffectColor.a;
                return fixed4(finalColor, node.a * _AlphaPower);
            }
            ENDCG
        }
