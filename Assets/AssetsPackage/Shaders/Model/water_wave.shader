    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_1909 = (((o.uv0+node_6252.g*float2(-0.5,0))+(o.uv0+node_6252.g*float2(-0.5,0)))*_Repeat);
...
////// Lighting:
                float4 node_6252 = _Time;
                float2 node_1909 = (((i.uv0+node_6252.g*float2(-0.5,0))+(i.uv0+node_6252.g*float2(-0.5,0)))*_Repeat);
                float4 _Main_Tex_var = tex2D(_Main_Tex,TRANSFORM_TEX(node_1909, _Main_Tex));
                float2 node_1280 = ((i.uv0+node_6252.g*float2(0,0))+_Main_Tex_var.r);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_8702 = _Time;
                float2 node_1909 = (((o.uv0+node_8702.g*float2(-0.5,0))+(o.uv0+node_8702.g*float2(-0.5,0)))*_Repeat);
                float4 _Main_Tex_var = tex2Dlod(_Main_Tex,float4(TRANSFORM_TEX(node_1909, _Main_Tex),0.0,0));
                v.vertex.xyz += (_Vertex*v.normal*_Main_Tex_var.g);
                o.posWorld = mul(unity_ObjectToWorld, v.vertex);
                o.pos = UnityObjectToClipPos( v.vertex );
