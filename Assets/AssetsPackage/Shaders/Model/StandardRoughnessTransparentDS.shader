Shader "DoubleSided/Standard/Transprent DS (Roughness setup)"
{
	Properties
	{
		...
		[HideInInspector] _AlphaTex("AlbedoAlpha", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "PbrInclude/StandardDSCoreTransparentForward.cginc"
