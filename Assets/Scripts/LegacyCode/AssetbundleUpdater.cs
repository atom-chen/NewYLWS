...
//        if (PlatformMgr.instance.IsInternalVersion())
//        {
...
//        {
//            PlatformMgr.instance.noticeVersion = persistentNoticeVersion;
//        }
//        else
//        {
//            PlatformMgr.instance.noticeVersion = "1.0.0";
//        }
...
//    {
//        var platform = string.Format("package={0}&app_version={1}&res_version={2}&notice_version={3}", PlatformMgr.instance.packageName, PlatformMgr.instance.appVersion, clientResVersion, PlatformMgr.instance.noticeVersion);
...
//        SimpleHttp.HttpPost(Setting.START_UP_URL, null, DataUtils.StringToBytes(platform), (WWW wwwInfo) => {
...
//            }
//            if (urlList.ContainsKey("order_url"))
//            {
//                Setting.ORDER_URL = urlList["order_url"].ToString();
//            }
//            if (urlList.ContainsKey("aborder_url"))
//            {
//                Setting.ABORDER_URL = urlList["aborder_url"].ToString();
//            }
//            if (urlList.ContainsKey("showbindphonebtn"))
//            {
//                Setting.IsShowBindPhoneBtn = urlList["showbindphonebtn"].ToString() == "1";
//            }
//            if (urlList.ContainsKey("charge_url"))
//            {
//                Setting.NOTIFY_URL = urlList["charge_url"].ToString();
//            }
//            if (urlList.ContainsKey("openTuiSong"))
//            {
//                string openTuiSong = urlList["openTuiSong"].ToString();
//                PlatformMgr.instance.isOpenTuiSong = openTuiSong == "1";
//            }
//            if (urlList.ContainsKey("charge_url1"))
//            {
//                Setting.NOTIFY_URL1 = urlList["charge_url1"].ToString();
//            }
//            if (urlList.ContainsKey("pay_way"))
//            {
//                Setting.APPPAY_WAY = urlList["pay_way"].ToString();
//            }
...
//            {
//                PlatformMgr.instance.noticeVersion = urlList["notice_version"].ToString();
//                GameUtility.SafeWriteAllText(noticeVersionPath, PlatformMgr.instance.noticeVersion);
//            }
//            if (urlList.ContainsKey("notice_url") && !string.IsNullOrEmpty(urlList["notice_url"].ToString()))
//            {
//                noticeUrl = urlList["notice_url"].ToString();
//            }
//            if (urlList.ContainsKey("commentary_url") && !string.IsNullOrEmpty(urlList["commentary_url"].ToString()))
//            {
//                Setting.WUJIANG_EVALUATE_URL = urlList["commentary_url"].ToString();
//            }
//            if (urlList.ContainsKey("auto_login") && !string.IsNullOrEmpty(urlList["auto_login"].ToString()))
//            {
//                Setting.AUTO_LOGIN = urlList["auto_login"].ToString();
//            }
...
//            sb.AppendFormat("ORDER_URL = {0}\n", Setting.ORDER_URL);
//            sb.AppendFormat("ABORDER_URL = {0}\n", Setting.ABORDER_URL);
//            sb.AppendFormat("NOTIFY_URL = {0}\n", Setting.NOTIFY_URL);
//            sb.AppendFormat("NOTIFY_URL1 = {0}\n", Setting.NOTIFY_URL1);
//            sb.AppendFormat("APPPAY_WAY = {0}\n", Setting.APPPAY_WAY);
//            sb.AppendFormat("WUJIANG_EVALUATE_URL = {0}\n", Setting.WUJIANG_EVALUATE_URL);
//            sb.AppendFormat("AUTO_LOGIN = {0}\n", Setting.AUTO_LOGIN);
//            sb.AppendFormat("APP_ADDR = {0}\n", Setting.APP_ADDR);
//            sb.AppendFormat("SERVER_RESOURCE_ADDR = {0}\n", Setting.SERVER_RESOURCE_ADDR);
//            sb.AppendFormat("openTuiSong = {0}\n", PlatformMgr.instance.isOpenTuiSong);
//            sb.AppendFormat("noticeVersion = {0}\n", PlatformMgr.instance.noticeVersion);
...
//#elif UNITY_IPHONE
//        PlatformMgr.instance.StartDownLoadGame(Setting.APP_ADDR);
//#endif
//        yield break;
//    }
...
//        PlatformMgr.instance.StartDownLoadGame(Setting.APP_ADDR, DownloadGameSuccess, DownloadGameFail, (int progress) =>
//        {
//            slider.normalizedValue = progress;
//        }, string.Format(APK_FILE_PATH, PlatformMgr.instance.packageName, bigServerVersion));
//    }
...
//        {
//            PlatformMgr.instance.InstallGame(DownloadGameSuccess, DownloadGameFail);
//        });
//    }
...
//        PlatformMgr.instance.resVersion = clientResVersion;
