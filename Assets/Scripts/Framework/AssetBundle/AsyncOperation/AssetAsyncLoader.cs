...
namespace AssetBundles
{
    ...
    public class AssetAsyncLoader : BaseAssetAsyncLoader
    {
        ...
        public override void Update()
        {
            ...
            var curAssetbundle = AssetBundleMgr.Instance.GetAssetBundleCache(assetbundleLoader.assetbundleName);
            if (curAssetbundle != null)
            {
                asset =  curAssetbundle.LoadAsset(assetPath);
                AssetBundleMgr.Instance.AddAssetCache(AssetName, asset);
            }
        }
