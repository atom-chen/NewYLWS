...
public class BuildUtils
{
    ...
    public const string UpdateNoticeFileName = "updatenotice.txt";
    public const string LuaABFileName = "lualua.assetbundle";
    public const string AssetsMapFileName = "assetsmap_bytesassetsmap_bytes.assetbundle";
    public const string StartUpFileName = "startup_backup.bytes";
