...
namespace XLua.CSObjectWrap
{
    ...
    public class SkipTrackWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SkipTrack);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					SkipTrack gen_ret = new SkipTrack();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SkipTrack constructor!");
        ...
        static int _m_CreateTrackMixer(RealStatePtr L)
        {
		    try {
                ...
                SkipTrack gen_to_be_invoked = (SkipTrack)translator.FastGetCSObj(L, 1);
