...
namespace XLua.CSObjectWrap
{
    ...
    public class SkipMixerBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(SkipMixerBehaviour);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "markerClips", _g_get_markerClips);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "markerClips", _s_set_markerClips);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					SkipMixerBehaviour gen_ret = new SkipMixerBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to SkipMixerBehaviour constructor!");
        ...
        static int _m_OnPlayableCreate(RealStatePtr L)
        {
		    try {
                ...
                SkipMixerBehaviour gen_to_be_invoked = (SkipMixerBehaviour)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_markerClips(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SkipMixerBehaviour gen_to_be_invoked = (SkipMixerBehaviour)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.markerClips);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_markerClips(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                SkipMixerBehaviour gen_to_be_invoked = (SkipMixerBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.markerClips = (System.Collections.Generic.Dictionary<string, double>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<string, double>));
