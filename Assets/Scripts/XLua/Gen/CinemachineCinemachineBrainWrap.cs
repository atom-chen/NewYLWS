...
namespace XLua.CSObjectWrap
{
    ...
    public class CinemachineCinemachineBrainWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 1, 16, 10);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "m_OpenDepthTexture", _g_get_m_OpenDepthTexture);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "m_OpenDepthTexture", _s_set_m_OpenDepthTexture);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_m_OpenDepthTexture(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.m_OpenDepthTexture);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_m_OpenDepthTexture(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.m_OpenDepthTexture = LuaAPI.lua_toboolean(L, 2);
        ...
        static int _s_set_m_CameraActivatedEvent(RealStatePtr L)
        {
		    try {
                ...
                Cinemachine.CinemachineBrain gen_to_be_invoked = (Cinemachine.CinemachineBrain)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.m_CameraActivatedEvent = (Cinemachine.CinemachineBrain.VcamEvent)translator.GetObject(L, 2, typeof(Cinemachine.CinemachineBrain.VcamEvent));
