...
namespace XLua.CSObjectWrap
{
    ...
    public class WaitEventClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WaitEventClip);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					WaitEventClip gen_ret = new WaitEventClip();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WaitEventClip constructor!");
        ...
        static int _m_CreatePlayable(RealStatePtr L)
        {
		    try {
                ...
                WaitEventClip gen_to_be_invoked = (WaitEventClip)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_param(RealStatePtr L)
        {
		    try {
                ...
                WaitEventClip gen_to_be_invoked = (WaitEventClip)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.param = (WaitEventBehaviour)translator.GetObject(L, 2, typeof(WaitEventBehaviour));
