...
namespace XLua.CSObjectWrap
{
    ...
    public class DialogueClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DialogueClip);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DialogueClip gen_ret = new DialogueClip();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DialogueClip constructor!");
        ...
        static int _m_CreatePlayable(RealStatePtr L)
        {
		    try {
                ...
                DialogueClip gen_to_be_invoked = (DialogueClip)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_param(RealStatePtr L)
        {
		    try {
                ...
                DialogueClip gen_to_be_invoked = (DialogueClip)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.param = (DialogueBehaviour)translator.GetObject(L, 2, typeof(DialogueBehaviour));
