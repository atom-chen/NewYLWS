...
namespace XLua.CSObjectWrap
{
    ...
    public class MotionBlurEffectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MotionBlurEffect);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "StopEffect", _m_StopEffect_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MotionBlurEffect gen_ret = new MotionBlurEffect();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MotionBlurEffect constructor!");
        ...
        static int _m_ApplyEffect_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.GameObject _cameraGO = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                    UnityEngine.Material _mat = (UnityEngine.Material)translator.GetObject(L, 2, typeof(UnityEngine.Material));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    float _blurAmount = (float)LuaAPI.lua_tonumber(L, 4);
                    
                    MotionBlurEffect.ApplyEffect( _cameraGO, _mat, _duration, _blurAmount );
        ...
        static int _m_Init(RealStatePtr L)
        {
		    try {
                ...
                MotionBlurEffect gen_to_be_invoked = (MotionBlurEffect)translator.FastGetCSObj(L, 1);
                ...
                
                {
                    ...
                    gen_to_be_invoked.Init( _mat, _duration, _blurAmount );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_StopEffect_xlua_st_(RealStatePtr L)
        {
		    try {
