...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleMgrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(AssetBundles.AssetBundleMgr);
			Utils.BeginObjectRegister(type, L, translator, 0, 26, 2, 1);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RemoveAssetBundleCache", _m_RemoveAssetBundleCache);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddAssetBundleCache", _m_AddAssetBundleCache);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					AssetBundles.AssetBundleMgr gen_ret = new AssetBundles.AssetBundleMgr();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleMgr constructor!");
        ...
        static int _m_TestHotfix(RealStatePtr L)
        {
		    try {
                ...
                AssetBundles.AssetBundleMgr gen_to_be_invoked = (AssetBundles.AssetBundleMgr)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RemoveAssetBundleCache(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveAssetBundleCache( _assetbundleName );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddAssetBundleCache(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                    UnityEngine.AssetBundle _assetbundle = (UnityEngine.AssetBundle)translator.GetObject(L, 3, typeof(UnityEngine.AssetBundle));
                    
                    gen_to_be_invoked.AddAssetBundleCache( _assetbundleName, _assetbundle );
        ...
        static int _m_RequestAssetFileAsync(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleMgr.RequestAssetFileAsync!");
        ...
        static int _m_UnloadAssetBundleDependencies(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.UnloadAssetBundleDependencies( _assetbundleName );
        ...
        static int _m_TryUnloadAssetBundle(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _unloadAllLoadedObjects = LuaAPI.lua_toboolean(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.TryUnloadAssetBundle( _assetbundleName, _unloadAllLoadedObjects );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _assetbundleName = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.TryUnloadAssetBundle( _assetbundleName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleMgr.TryUnloadAssetBundle!");
        ...
        static int _m_UnloadUnusedAssetBundles(RealStatePtr L)
        {
		    try {
                ...
                {
                    bool _unloadResident = LuaAPI.lua_toboolean(L, 2);
                    bool _unloadAllLoadedObjects = LuaAPI.lua_toboolean(L, 3);
                    
                    gen_to_be_invoked.UnloadUnusedAssetBundles( _unloadResident, _unloadAllLoadedObjects );
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.UnloadUnusedAssetBundles( _unloadResident );
                ...
                if(gen_param_count == 1) 
                {
                    ...
                    gen_to_be_invoked.UnloadUnusedAssetBundles(  );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleMgr.UnloadUnusedAssetBundles!");
        ...
        static int _g_get_ManifestBundleName(RealStatePtr L)
        {
		    try {
			    ...
			    LuaAPI.lua_pushstring(L, AssetBundles.AssetBundleMgr.ManifestBundleName);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_ManifestBundleName(RealStatePtr L)
        {
		    try {
			    ...
			    AssetBundles.AssetBundleMgr.ManifestBundleName = LuaAPI.lua_tostring(L, 1);
