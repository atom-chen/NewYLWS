...
namespace XLua.CSObjectWrap
{
    ...
    public class FlyCurveWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(FlyCurve);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to FlyCurve constructor!");
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FlyCurve gen_ret = FlyCurve.Begin( _go, _startPosition, _point, _targetPosition, _duration );
                        translator.Push(L, gen_ret);
