...
namespace XLua.CSObjectWrap
{
    ...
    public class WaitEventBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WaitEventBehaviour);
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "waitWhatEvent", _g_get_waitWhatEvent);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "waitWhatEvent", _s_set_waitWhatEvent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					WaitEventBehaviour gen_ret = new WaitEventBehaviour();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WaitEventBehaviour constructor!");
        ...
        static int _m_OnPlayableCreate(RealStatePtr L)
        {
		    try {
                ...
                WaitEventBehaviour gen_to_be_invoked = (WaitEventBehaviour)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_waitWhatEvent(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                WaitEventBehaviour gen_to_be_invoked = (WaitEventBehaviour)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.waitWhatEvent);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_waitWhatEvent(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                WaitEventBehaviour gen_to_be_invoked = (WaitEventBehaviour)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.waitWhatEvent = LuaAPI.xlua_tointeger(L, 2);
