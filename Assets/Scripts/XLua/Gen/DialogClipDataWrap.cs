...
namespace XLua.CSObjectWrap
{
    ...
    public class DialogClipDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DialogClipData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DialogClipData gen_ret = new DialogClipData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DialogClipData constructor!");
        ...
        static int _g_get_uiName(RealStatePtr L)
        {
		    try {
                ...
                DialogClipData gen_to_be_invoked = (DialogClipData)translator.FastGetCSObj(L, 1);
