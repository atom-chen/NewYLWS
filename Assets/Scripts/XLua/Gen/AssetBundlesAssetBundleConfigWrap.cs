...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 16, 5, 2);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "EditorModeFileName", AssetBundles.AssetBundleConfig.EditorModeFileName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "SimulateModeFileName", AssetBundles.AssetBundleConfig.SimulateModeFileName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ABUpdateFileName", AssetBundles.AssetBundleConfig.ABUpdateFileName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ExcludeFormApkFileName", AssetBundles.AssetBundleConfig.ExcludeFormApkFileName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "AssetBundlesVersionFileName", AssetBundles.AssetBundleConfig.AssetBundlesVersionFileName);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					AssetBundles.AssetBundleConfig gen_ret = new AssetBundles.AssetBundleConfig();
