...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "InitLuaAB", _m_InitLuaAB);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "OnInit", _m_OnInit);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Restart", _m_Restart);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CoroutineRestart", _m_CoroutineRestart);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_InitLuaAB(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.IEnumerator gen_ret = gen_to_be_invoked.InitLuaAB(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CoroutineRestart(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        System.Collections.IEnumerator gen_ret = gen_to_be_invoked.CoroutineRestart(  );
                        translator.PushAny(L, gen_ret);
