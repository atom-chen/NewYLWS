    ...
    public class AssetBundlesManifestWrap 
    {
        ...
        static int _m_CompareTo(RealStatePtr L)
        {
		    try {
                ...
                {
                    AssetBundles.Manifest _manifest = (AssetBundles.Manifest)translator.GetObject(L, 2, typeof(AssetBundles.Manifest));
                    
                        System.Collections.Generic.List<string> gen_ret = gen_to_be_invoked.CompareTo( _manifest );
                        translator.Push(L, gen_ret);
