    ...
    public class SystemCollectionsGenericDictionary_2_SystemStringUnityEngineGameObject_Wrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
					System.Collections.Generic.IDictionary<string, UnityEngine.GameObject> _dictionary = (System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>));
					
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(_dictionary);
					translator.Push(L, gen_ret);
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<string, UnityEngine.GameObject>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<string>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<string, UnityEngine.GameObject> gen_ret = new System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>(_dictionary, _comparer);
					translator.Push(L, gen_ret);
