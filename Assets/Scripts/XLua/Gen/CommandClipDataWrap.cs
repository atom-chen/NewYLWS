...
namespace XLua.CSObjectWrap
{
    ...
    public class CommandClipDataWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CommandClipData);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					CommandClipData gen_ret = new CommandClipData();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CommandClipData constructor!");
        ...
        static int _g_get_commandID(RealStatePtr L)
        {
		    try {
                ...
                CommandClipData gen_to_be_invoked = (CommandClipData)translator.FastGetCSObj(L, 1);
