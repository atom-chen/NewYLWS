...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetBundlesAssetBundleUtilityWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "FinalFixABName", _m_FinalFixABName_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "PackagePathToDataPath", _m_PackagePathToDataPath_xlua_st_);
        ...
        static int _m_AssetBundlePathToAssetBundleName_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                    bool _fixABName = LuaAPI.lua_toboolean(L, 2);
                    
                        string gen_ret = AssetBundles.AssetBundleUtility.AssetBundlePathToAssetBundleName( _assetPath, _fixABName );
                        LuaAPI.lua_pushstring(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetBundles.AssetBundleUtility.AssetBundlePathToAssetBundleName!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FinalFixABName_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = AssetBundles.AssetBundleUtility.FinalFixABName( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PackagePathToDataPath_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _assetPath = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = AssetBundles.AssetBundleUtility.PackagePathToDataPath( _assetPath );
                        LuaAPI.lua_pushstring(L, gen_ret);
