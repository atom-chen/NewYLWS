...
namespace XLua.CSObjectWrap
{
    ...
    public class Battle_ActorActorTranslucentColorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Battle_Actor.ActorTranslucentColor);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Battle_Actor.ActorTranslucentColor gen_ret = new Battle_Actor.ActorTranslucentColor();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battle_Actor.ActorTranslucentColor constructor!");
        ...
        static int _m_Clear(RealStatePtr L)
        {
		    try {
                ...
                Battle_Actor.ActorTranslucentColor gen_to_be_invoked = (Battle_Actor.ActorTranslucentColor)translator.FastGetCSObj(L, 1);
        ...
        static int _m_AddColorFactor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battle_Actor.ActorTranslucentColor.AddColorFactor!");
        ...
        static int _m_AddColorPowerFactor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battle_Actor.ActorTranslucentColor.AddColorPowerFactor!");
        ...
        static int _m_AddAlphaFactor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Battle_Actor.ActorTranslucentColor.AddAlphaFactor!");
