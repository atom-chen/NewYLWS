...
namespace XLua.CSObjectWrap
{
    ...
    public class TMProTMP_TextWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 14, 84, 61);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					TMPro.TMP_Text gen_ret = new TMPro.TMP_Text();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to TMPro.TMP_Text constructor!");
