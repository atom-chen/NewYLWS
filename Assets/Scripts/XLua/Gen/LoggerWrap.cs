...
namespace XLua.CSObjectWrap
{
    ...
    public class LoggerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 9, 10, 8);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "errorReportUri", _g_get_errorReportUri);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "errorReportUri", _s_set_errorReportUri);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_errorReportUri(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.lua_pushstring(L, Logger.errorReportUri);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_errorReportUri(RealStatePtr L)
        {
		    try {
                
			    Logger.errorReportUri = LuaAPI.lua_tostring(L, 1);
