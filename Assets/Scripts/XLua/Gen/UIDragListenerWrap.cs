...
namespace XLua.CSObjectWrap
{
    ...
    public class UIDragListenerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UIDragListener);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UIDragListener gen_ret = new UIDragListener();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UIDragListener constructor!");
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        UIDragListener gen_ret = UIDragListener.Get( _go );
                        translator.Push(L, gen_ret);
        ...
        static int _m_OnBeginDrag(RealStatePtr L)
        {
		    try {
                ...
                UIDragListener gen_to_be_invoked = (UIDragListener)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_onDrag(RealStatePtr L)
        {
		    try {
                ...
                UIDragListener gen_to_be_invoked = (UIDragListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDrag = translator.GetDelegate<UIDragListener.VoidDelegate>(L, 2);
        ...
        static int _s_set_onDragBegin(RealStatePtr L)
        {
		    try {
                ...
                UIDragListener gen_to_be_invoked = (UIDragListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDragBegin = translator.GetDelegate<UIDragListener.VoidDelegate>(L, 2);
        ...
        static int _s_set_onDragEnd(RealStatePtr L)
        {
		    try {
                ...
                UIDragListener gen_to_be_invoked = (UIDragListener)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onDragEnd = translator.GetDelegate<UIDragListener.VoidDelegate>(L, 2);
