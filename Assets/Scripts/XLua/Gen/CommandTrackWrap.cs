...
namespace XLua.CSObjectWrap
{
    ...
    public class CommandTrackWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CommandTrack);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					CommandTrack gen_ret = new CommandTrack();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CommandTrack constructor!");
        ...
        static int _m_CreateTrackMixer(RealStatePtr L)
        {
		    try {
                ...
                CommandTrack gen_to_be_invoked = (CommandTrack)translator.FastGetCSObj(L, 1);
