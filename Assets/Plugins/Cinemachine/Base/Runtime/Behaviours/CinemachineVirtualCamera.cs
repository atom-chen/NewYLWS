...
namespace Cinemachine
{
    ...
    public class CinemachineVirtualCamera : CinemachineVirtualCameraBase
    {
        ...
        public void ModifyCameraDistance(float deltaDistance)
        {
            CinemachineFramingTransposer transposer = GetCinemachineComponent<CinemachineFramingTransposer>();
            if (transposer != null)
            {
                float distance = transposer.m_CameraDistance + deltaDistance;
                distance = distance > transposer.m_MinimumDistance ? distance : transposer.m_MinimumDistance;
                distance = distance < transposer.m_MaximumDistance ? distance : transposer.m_MaximumDistance;
