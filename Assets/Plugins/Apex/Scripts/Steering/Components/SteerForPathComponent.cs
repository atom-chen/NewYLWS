...
namespace Apex.Steering.Components
{
    ...
    public class SteerForPathComponent : SteeringComponent, ISteerable, INeedPath, IAdjustUpdateInterval
    {
        ...
        /// </summary>
        public SlowingAlgorithm slowingAlgorithm = SlowingAlgorithm.Linear;
        ...
        private bool ProcessAndValidateResult(PathResult result)
        {
            ...
            switch (result.status)
            {
                case PathingStatus.Complete:
                {
                    ...
                    msgEvent = UnitNavigationEventMessage.Event.PathingComplete;
                    AnnounceEvent(msgEvent, Vector3.one, null);
                    return true;
                }
