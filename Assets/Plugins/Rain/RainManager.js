...
class RainManager extends MonoBehaviour 
{
	...
	public function Start () {
			...
			if (generateNewAssetsOnStart) {
				...
				AssetDatabase.CreateAsset(m1, "Assets/Zone/Copy/Chapter1/Common/Rain/RainFx/" + gameObject.name + "_LQ0.asset");
				AssetDatabase.CreateAsset(m2, "Assets/Zone/Copy/Chapter1/Common/Rain/RainFx/" + gameObject.name + "_LQ1.asset");
				AssetDatabase.CreateAsset(m3, "Assets/Zone/Copy/Chapter1/Common/Rain/RainFx/" + gameObject.name + "_LQ2.asset");
	...
	function CreateMesh () : Mesh {
		...
		var particleNum : int = numberOfParticles / 2;
