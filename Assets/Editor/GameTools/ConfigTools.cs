...
public class ConfigTools : EditorWindow
{
    ...
    static void Init()
    {
        ScriptableObject.CreateInstance<ConfigTools>();
    ...
    private void OnGUI()
    {
        ...
        xlsxFolder = GUILayout.TextField(xlsxFolder, GUILayout.Width(500));
        ...
        protoFolder = GUILayout.TextField(protoFolder, GUILayout.Width(500));
        if (GUILayout.Button("...", GUILayout.Width(40)))
        {
            SelectProtoFolder();
        }
    ...
    private void XlsxGenLua()
    {
        ...
        p.StartInfo.Arguments = xlsxFolder + "/tools/toClientConfigs.py";
    ...
    void Update()
    {
        ...
        if (xlsxGenLuaFinished)
        {
            ...
            string[] luaFiles = Directory.GetFiles(xlsxFolder + "/tools/LuaConfigs");
    ...
    private bool CheckXlsxPath(string xlsxPath)
    {
        ...
        if (!File.Exists(xlsxPath + "/tools/toClientConfigs.py"))
        {
            EditorUtility.DisplayDialog("Error", "Err path :\nNo find ./tools/toClientConfigs.py", "Conform");
            return false;
        }
