...
{
    return fx_divx(fx_mulx(xAngle, fx_dtox(3.1416, FRACT_LIMIT), FRACT_LIMIT), fx_dtox(180, FRACT_LIMIT), FRACT_LIMIT);
}

fixed_t 
fx_radian_to_angle(fixed_t xRadian)
{
    return fx_divx(fx_mulx(xRadian, fx_dtox(180, FRACT_LIMIT), FRACT_LIMIT), fx_dtox(3.1416, FRACT_LIMIT), FRACT_LIMIT);
}
...
{
    /* The 320 bytes large lookup table of polynomial coefficients */
    static const int64_t table[16][5] =
    ...
    int64_t c0, c1, c2, c3, c4;  /* Polynomial coefficients   Q.31     */
    int64_t x1, x2, x3, x4;      /* Fractional powers         Q.32     */
