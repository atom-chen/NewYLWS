...
#define FX_IMPL_ROUNDX(xval, frac) \
    (int64_t)((frac) ? (((xval) >> ((frac) - 1)) + 1) >> 1 : (xval))

#define FX_IMPL_CEILX(xval, frac) \
    (int64_t)(((int64_t)(xval) + (int64_t)((1UL << (frac)) - 1)) >> (frac))
...
#define FX_IMPL_DIVX(x1, x2, frac)                                    \
    (int64_t)((((int64_t)(x1) << (frac)) +                            \
               ((int64_t)(x1) < 0 ? -labs(x2) : labs(x2)) / 2) / (x2))
